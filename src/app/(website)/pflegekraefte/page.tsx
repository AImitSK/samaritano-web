...
const VOICES = [
  {
    ...
    img: '/uploads/_DSC9603.jpg',
    q: 'Ich werde gefragt, wo ich arbeiten möchte, nicht, wo gerade ein Loch zu stopfen ist.',
  },
  {
    name: 'Magnus R.',
    role: 'Kinderkrankenpfleger',
    img: '/uploads/_DSC9356-Bearbeitet.jpg',
    q: 'In zehn Jahren Pflege noch nie so persönlich begleitet gefühlt wie hier.',
  },
  {
    name: 'John W.',
    role: 'Endoskopie-Pfleger',
    img: '/uploads/_DSC9544.jpg',
    q: 'Drei Vorschläge, einer davon mein heutiger Job. Sechs Tage von Anruf zu Vertrag.',
  },
]
            ...
            {VOICES.map((p) => (
              <div key={p.name} className="flex flex-col gap-6">
                ...
                <div>
                  ...
                  <div className="mt-0.5 text-[14px] text-white/60">{p.role}</div>
                </div>
              </div>
            ))}
          </div>
